...
namespace Runner
{
    public partial class Igra2 : Form
    {
        ...
        void t4_Tick(object sender, EventArgs e)
        {
            if (Program.f == 0)
            {
                ...
                if (progressBar1.Value == 0)
                {
                    ...
                    rez = MessageBox.Show("Kraj na igrata. Osvoivte: " + Poeni + " poeni.", "", MessageBoxButtons.OK);
        ...
        private void Igra2_KeyUp(object sender, KeyEventArgs e)
        {
            if (paga == false)
            {
        ...
        private void Igra2_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void Igra2_Load(object sender, EventArgs e)
        {
